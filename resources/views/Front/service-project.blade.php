    ...
    <section class="page-title page-title-12" id="page-title">
        <div class="page-title-wrap bg-overlay bg-overlay-dark-3">
            <div class="bg-section">
                <img src="{{ asset($slider->image_project) }}" alt="Background"/>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-6 offset-lg-3">
                        <div class="title text-center">
                            <h1 class="title-heading">{{ trans_model($service,'title') }}</h1>
                            <p class="title-desc">
{{--                                {!!  Strtrans_model($service,'desc')  !!}--}}
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="breadcrumb-wrap">
            <div class="container">
                <ol class="breadcrumb d-flex">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('service') }}">@lang('site.services')</a></li>
