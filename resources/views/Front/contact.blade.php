                        ...
                        <div class="img-card img-card-2 bg-overlay bg-overlay-theme">
                            ...
                            <div class="card-content">
                                <div class="content-top">
                                    <p>
                                        {{ lang() == 'ar' ? 'تأسست MCI استجابة لطلب السوق المتزايد على ارتفاع
حلول مبتكرة عالية الجودة وبأسعار معقولة.' : 'MCI was established in response to the increasing market demand
Innovative high -quality solutions at reasonable prices.' }}
                                    </p>
                                    ...
                                    <ul class="list-unstyled contact-infos">
                                        <li class="contact-info">
                                            ...
                                            <p>
                                                ...
                                                <a href="#">{{ Str::limit($settings->phone,13,'') }}</a>
                                            </p>
                                        </li>
                                        <li class="contact-info">
