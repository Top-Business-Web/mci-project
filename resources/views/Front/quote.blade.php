                                                    ...
                                                    <div class="product" style="display: flex;margin-bottom: 15px;">
                                                        ...
                                                        <div class="product-desc">
                                                            <div class="product-title">
                                                                <h5 style="position: absolute;margin: 30px 25px 25px 38px">
                                ...
                                <div>
                                    <div class="row">
                                        <div class="col-12 d-flex justify-content-center">
                                            <button class="btn btn--secondary w-25" id="quote-btn" type="button">
        ...
        $('#quote-btn').on('click', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status === 200) {
                        toastr.success('Thanks For Quote we call you');
                        $('#quote-btn').html('Thanks For Quote we call you');
                        $('#quote-btn').prop('disabled', 'ture');
