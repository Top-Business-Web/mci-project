    ...
    <div class="row mt-4">
        <div class="col-12">
            <div class="card" style="padding: 13px">
                ...
                <div class="table">
                    <table class="table table-responsive data-table YAJRA" id="dataTable"
...
@section('js')
    ...
    <script>
        ...
        $(document).on('click', '.changeStock', function () {
            var id = $(this).data('id');
            // alert(id);
            $.ajax({
                url: '{{ route('changeStock')}}',
                method: 'post',
                data: {
                    'id': id,
                    '_token': '{{ csrf_token() }}',
